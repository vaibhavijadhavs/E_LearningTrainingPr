	...
	<div class="row">
		...
		<div class="container">
			...
			<div class="container text-left">
				...
				<a href="<%=request.getContextPath()%>/showUserLogin" class="btn btn-success">Login</a>
            ...
            <c:forEach var="book" items="${listUser}">
                <tr>
                    ...
                    <td>
						...
						<a href="<%=request.getContextPath()%>/enroll?id=<c:out value='${book.course_id}' />" class="btn btn-primary" >Enroll</a>  
					</td>
                </tr>
            </c:forEach>
        </table>
